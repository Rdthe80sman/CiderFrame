...
Currently only the windows version has been modified (As my made macine at the moment is a windows 11 machine). But it does not work correctly See Disclamer

# Disclaimer
I am not fluent in programing in C++ or Python so the only way ive made these modifactions was by using nobodys favorite tool (AI Assitiance) I would apriciate if anyone can download this code to get it to work better.
